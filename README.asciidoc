...
link:doc/linux-build.md[Detailed instructions] for doing so are available.
...
|         |     2+a| **``▗▚▚▚▚ <libi86/stdio.h> ▞▞▞▞▖``**
			...
			* **Under newer versions of `gcc-ia16`, ``<stdio.h>`` will also automatically include ``<libi86/stdio.h>``, unless GCC is in "strict ANSI" or `gnu89` mode.**
...
|         |     2+a| **``▗▚▚▚▚ <libi86/stdlib.h> ▞▞▞▞▖``**
			...
			* **Under newer versions of `gcc-ia16`, ``<stdlib.h>`` will also automatically include ``<libi86/stdlib.h>``, unless GCC is in "strict ANSI" or `gnu89` mode.**
...
|         |     2+a| **``▗▚▚▚▚ <libi86/string.h> ▞▞▞▞▖``**
			...
			* **Under newer versions of `gcc-ia16`, ``<string.h>`` will also automatically include ``<libi86/string.h>``, unless GCC is in "strict ANSI" or `gnu89` mode.**
